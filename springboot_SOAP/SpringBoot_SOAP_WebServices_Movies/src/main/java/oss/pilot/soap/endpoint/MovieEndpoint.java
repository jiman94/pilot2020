package oss.pilot.soap.endpoint;
...
import oss.pilot.soap.service.MovieEntityService;
import oss.pilot.soap.ws.AddMovieRequest;
import oss.pilot.soap.ws.AddMovieResponse;
import oss.pilot.soap.ws.DeleteMovieRequest;
import oss.pilot.soap.ws.DeleteMovieResponse;
import oss.pilot.soap.ws.GetAllMoviesRequest;
import oss.pilot.soap.ws.GetAllMoviesResponse;
import oss.pilot.soap.ws.GetMovieByIdRequest;
import oss.pilot.soap.ws.GetMovieByIdResponse;
import oss.pilot.soap.ws.MovieType;
import oss.pilot.soap.ws.ServiceStatus;
import oss.pilot.soap.ws.UpdateMovieRequest;
import oss.pilot.soap.ws.UpdateMovieResponse;

@Endpoint
public class MovieEndpoint {

	public static final String NAMESPACE_URI = "http://wwwpilotcom/movies-ws";
